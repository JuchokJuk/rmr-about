...
import { initArticle } from "@store/articles/articlesAction";
...
const ArticlePage = ({ scrollPosition }) => {
                ...
                <div className="st1">
                    <div className={"grid-container"}>
                        <div className={"grid-col-6"}>
                            <GoHomeButton mainTag={state.data.mainTag} />
                        </div>
                    </div>
                    ...
                    <div className="main-page__mailingList">
                        <div className="main-page__mailingList--content">
                            <Mailing labelGA="NewsletterSubscribeArticle" />
                        </div>
                    </div>

                    <Footer
                        similarTags={state.data.similarTags}
...
export const getServerSideProps = storeWrapper.getServerSideProps(
    async ({ store, query, res }) => {
        await Promise.allSettled([
            store.dispatch(initArticle(query.tag, query.article)),
...
export default trackWindowScroll(ArticlePage);
